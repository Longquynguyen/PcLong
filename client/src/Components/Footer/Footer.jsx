                    ...
                    <div className={cx('showroom-list')}>
                        <div className={cx('showroom-item')}>
                            <div className={cx('showroom-header')}>
                                ...
                                <div className={cx('showroom-name')}>SHOWROOM HÀ NỘI</div>
                            </div>
                            <div className={cx('showroom-info')}>
                                <div className={cx('info-item')}>
                                    <FontAwesomeIcon icon={faMapMarkerAlt} />
                                    <span>Địa chỉ: 83-85 Tân Hội, Đan Phượng, Hà Nội</span>
                                </div>

                                <div className={cx('info-item')}>
                                    <FontAwesomeIcon icon={faPhone} />
                                    <span>Liên hệ 24/7 Tel: 0394588683</span>
                                </div>
                                <div className={cx('info-item')}>
                        ...
                        <div className={cx('showroom-item')}>
                            <div className={cx('showroom-header')}>
                                ...
                                <div className={cx('showroom-name')}>SHOWROOM HỒ CHÍ MINH</div>
                            </div>
                            <div className={cx('showroom-info')}>
                                <div className={cx('info-item')}>
                                    <FontAwesomeIcon icon={faMapMarkerAlt} />
                                    <span>Địa chỉ: Số 83A Nhuệ Giang, Quận 10, TP Hồ Chí Minh</span>
                                </div>
